					...
					<tr>
						<td colSpan={3} scope="row">
							<div class="input-group ">
								...
								<input type={typeSenha} autoComplete="off" name="senha" id="senha" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" />
					...
					<tr>
						<td colSpan={3} scope="row">
							<div class="input-group ">
								...
								<input type={typeReSenha} autoComplete="off" name="resenha" id="re-senha" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" />
