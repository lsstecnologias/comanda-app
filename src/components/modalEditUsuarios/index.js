			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-footer ">
						<button type="button" class="btn btn-sm btn-primary w-100 m-0  btn-edigit" id="btnEditarUsuario" onClick={(e) => { editUsuario(e) }}><i class="bi bi-check2-circle"></i> Confirmar</button>
					</div>
