...
const ModalPrincipal = () => {
	...
	const addNovoEstabelecimento = (e) => {
		...
		var obj_est = { estabelecimento_id: estabelecimento_id, nome: null, sobrenome: null, rg: null, cpf: null, cnpj: null, cep: null, endereco: null, data_post: data_post };
							...
							<div class="col-sm-12 container-fluid">
								...
								<tr>
									...
									<td class="text-center mb-4">
										<h2 className='pb-2'>Olá, loremipsum</h2>
